...
// import "github.com/peak6/migrate/migrate" for usage within Go.
package main
...
import (
	...
	"github.com/peak6/migrate/migrate"
	"github.com/peak6/migrate/migrate/direction"
	pipep "github.com/peak6/migrate/pipe"
	"os"
	"strconv"
	"time"
)
